...
CREATE TABLE IF NOT EXISTS content_by_department(
    id INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
/*[BEGIN] Apply Constraints*/
    ...
    ALTER TABLE content_by_department ADD FOREIGN KEY (department_id) REFERENCES departments(id);
    ALTER TABLE content_by_department ADD FOREIGN KEY (content_id) REFERENCES content(id);
